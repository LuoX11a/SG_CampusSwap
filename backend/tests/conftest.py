...
@pytest.fixture
def auth_headers():
    """Return auth headers with a test JWT token.

    In real tests, you'd call POST /api/v1/auth/login first to get a real token.
    This fixture provides a pre-built header for convenience.
    """
    # This is a test token generated with the test secret
    # In production tests, generate this dynamically via login endpoint
...
def registered_user(client):
    ...
    Returns dict with: email, username, password, university, campus
    """
    user_data = {
